...
//            mMainDialogFragment.show(supportFragmentManager, COMING_SOON_DIALOG_TYPE);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == COPY_STORAGE_PROVIDER_RESULT) {
            if (data != null) {
                ...
                showSnackBarForSelectPhotos("Preparing for backup...", ContextCompat.getColor(this, R.color.blue));
            }
        }
    }
    ...
    public void showSnackBarForSelectPhotos(final String message, final int color) {
        final View bottomLine = findViewById(R.id.screen_bottom_line_view);
        final Snackbar snackbar = Snackbar.make(bottomLine, message, Snackbar.LENGTH_SHORT);
        snackbar.setBackgroundTint(color);
        snackbar.setAnchorView(bottomLine);
        snackbar.show();
    }
